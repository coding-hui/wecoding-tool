 ...
 */
package top.wecoding.core.feign.sentinel.handler;
 ...
 */
@Slf4j
public class WeCodingSentinelInvocationHandler implements InvocationHandler {
    ...
    public WeCodingSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
                ...
                try {
                    ...
                    if (fallbackFactory != null) {
                        ...
                        if (Response.class == method.getReturnType()) {
                            ...
                            return Response.buildFailure(ex.getLocalizedMessage());
                        } else {
                            throw ex;
                        }
                    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            WeCodingSentinelInvocationHandler other = (WeCodingSentinelInvocationHandler) obj;
