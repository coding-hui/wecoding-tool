 ...
 * @qq 1515418211
 */
public class WeCodingSentinelFeign {

    private WeCodingSentinelFeign() {
            ...
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target,
                    ...
                    if (void.class != fallback) {
                        ...
                        return new WeCodingSentinelInvocationHandler(target, dispatch,
                    ...
                    if (void.class != fallbackFactory) {
                        ...
                        return new WeCodingSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                    }
                    return new WeCodingSentinelInvocationHandler(target, dispatch);
                }
