...
public class AutoServiceProcessor extends AbstractWeCodingProcessor {

    /**
     * AutoService 注解名
     */
    private static final String AUTO_SERVICE_NAME = top.wecoding.core.auto.annotation.AutoService.class.getName();
